...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function validateForm() {
    ...
    let isValidEmail = /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email); // Email regex check
    let phonePattern = /^\d{11}$/.test(phone)

    // Enable button only if all fields are filled & email format is correct
    submitBtn.disabled = !(name && isValidEmail && phonePattern)
...
// const passKyc = document.getElementById('pass-kyc')
// document.querySelector('.reset').addEventListener('click', () => {
//   document.getElementById('form').reset()
// })
// function validateKYC () {
//   var name, email, phone, error, recipientName
...
//     error.style.display = 'block'
//     error.innerHTML = 'Please enter a valid 11-digit phone number.'
//   } else {
//     passKyc.disabled = false
//     error.style.display = 'none'
//   }
...
//   //   passKyc.disabled = false; 
//   // }
//   if (passKyc.hasAttribute("disabled")) {
//     passKyc.removeAttribute("disabled")
//   }

// }
// const checkKyc = document.getElementById('check-kyc') 
// checkKyc.addEventListener('click', () => {
//   validateKYC()
// })
